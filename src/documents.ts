export type PdfDocument = {
   ...
   * The `?v=` hash busts browser caches when the file is replaced; see readPdfStats
   * in vite.config.ts. The server ignores the query and serves the same file.
   */
  url: string;
...
export const MANUAL: PdfDocument = {
  url: `${import.meta.env.BASE_URL}manual.pdf?v=${__MANUAL_VERSION__}`,
...
export const TEAM_LIST: PdfDocument = {
  url: `${import.meta.env.BASE_URL}team-list.pdf?v=${__TEAM_LIST_VERSION__}`,
